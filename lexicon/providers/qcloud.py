...
NAMESERVER_DOMAINS = ['cns.api.qcloud.com']

def ProviderParser(subparser):
    subparser.add_argument("--auth-secret-id", help="specify api secret id for authentication")
...
class Provider(BaseProvider):
    ...
    def __init__(self, options, engine_overrides=None):
        ...
        self.domain_id = None
        self.api_endpoint = self.engine_overrides.get('api_endpoint', 'https://cns.api.qcloud.com/v2/index.php')
